                            ...
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item d-flex align-center pa-2">
                                        ...
                                        >
                                            ...
                                            <v-list class="pa-0" width="200px">
                                                <v-list-item class="pa-0">
                                                    <v-list-item-content>
                                                        <a href="" class="subtitle-2 text-decoration-none black--text" style="padding: 10px;">Tiếng Việt</a>
                                                        <a href="" class="subtitle-2 text-decoration-none black--text" style="padding: 10px;">English</a>
                                                    </v-list-item-content>
                                                </v-list-item>
                                            </v-list>
                                ...
                                >
                                    ...
                                    <template v-slot:activator="{on, attrs}">
                                        <a 
                                            ...
                                            v-on="on"
                                        >
                                            <v-badge content="12" color="#fa4c31" bordered overlap origin="150px 0px">
                                                <svg width="26" height="26" viewBox="0 0 26.6 25.6" class="shopee-svg-icon navbar__link-icon icon-shopping-cart-2">
                                                <title>Shopping Cart Icon</title>
                                                <polyline fill="none" stroke="currentColor" points="2 1.7 5.5 1.7 9.6 18.3 21.2 18.3 24.6 6.1 7 6.1" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2.5"></polyline>
                                                <circle cx="10.7" cy="23" r="2.2" stroke="currentColor" fill="currentColor"></circle>
                                                <circle cx="19.7" cy="23" r="2.2" stroke="currentColor" fill="currentColor"></circle>
                                            </svg>
                                            </v-badge>
                                        </a>
                                    </template>

                                    <v-list class="py-15" width="400px" height="240px">
                                        <v-list-item class="pa-0 d-flex justify-center">
                                            <v-list-item-content class="pa-0">
                                                <v-img
                                                    :src="require('@/assets/img/cart-noproduct.png')"
                                                    height="100px"
                                                    width="100px"
                                                ...
                                                <v-list-item-title class="subtitle-2 text-center">Chưa Có Sản Phẩm</v-list-item-title>
                                            </v-list-item-content>
                                        </v-list-item>
                                    </v-list>
                                </v-menu>
