<template>
    <v-app light >
        <header class="header" style="height: 120px; background-image: linear-gradient(-180deg, #f53d2d, #f63)">
            <div class="grid">
                <nav class="header__navbar d-flex justify-space-between">
                        ...
                        <v-list-item class="pa-0 mt-n2" >
                            <v-list-item-content class="pa-0 ">
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item header__navbar-item--separator">
                                    <a href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-2">Kênh Người Bán</a>
                                </v-list-item-title>
                            </v-list-item-content>
                            <v-list-item-content class="pa-0 ">
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item header__navbar-item--separator">
                                    <a href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-2">Trở thành Người bán Shopee</a>
                                </v-list-item-title>
                            </v-list-item-content>
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item header__navbar-item--separator">
                                    <a href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-2">Tải ứng dụng</a>
                                </v-list-item-title>
                            </v-list-item-content>
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item d-flex align-center   ">
                                    <span href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none py-2 pl-2 pr-1">Kết nối</span>
                        ...
                        <v-list-item class="pa-0 mt-n2" >
                            ...
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item d-flex align-center pa-2">
                                    ...
                                    <a href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-1">
                                        Tiếng Việt
                                        <v-icon dense color="white">mdi mdi-chevron-down</v-icon>
                                    </a>
                                </v-list-item-title>
                            </v-list-item-content>
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item d-flex align-center">
                                    <span href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-2 header__navbar-item--separator">Đăng ký</span>
                                </v-list-item-title>
                            </v-list-item-content>
                            <v-list-item-content class="pa-0" >
                                <v-list-item-title style="width: fit-content;" class="header__navbar-item d-flex align-center">
                                    <span href="" style="font-size: 14px; color: var(--white-color);" class="text-decoration-none pa-2">Đăng nhập</span>
                                </v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                    </v-list>
